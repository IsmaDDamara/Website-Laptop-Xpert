...
<div class='container-fluid'>
    <div class="container">
        <div class="title-section">
            <h2 class="text-center" style="color: #121212">PC</h2>
        </div>
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="card mt-5">
                    <img class="img-thumbnail mx-auto d-block" src="{{ asset('/storage/'.$product->getImage()) }}"
                        style=" border: none; width: 70%; height: 150px;">
